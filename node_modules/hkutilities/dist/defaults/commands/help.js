    ...
    callback: async (bot, message, args, hkandler) => {
        if (!args.length) {
            ...
            if (!command)
                ...
                if(typeof command.aliases == 'undefined') cannon_modify = 'The command doesn\'t have alias'
                else cannon_modify = command.aliases.join(', ')
            ...
            let embed = {
                ...
                fields: [
                    ...
                    {
                        name: "Cooldown",
                        value: `${command.cooldown || hkandler.defaultCooldown || 0} seconds`,
                    },
                    {
                        name: "Description",
