...
module.exports = {
    ...
    callback: async (client, message, args, hkandler, database) => {
      ...
      .setTitle(`@${data2.username ? data2.username : 'unknown'} profile`)
      .addFields(
          {name:`Some posts`, value: posts, inline: false},
          {name: 'Games', value: itens, inline: false},
          {name: 'Total of Followers', value: data2.followers ? data2.followers : 0, inline: false},
          {name: 'Total of Likes', value: data2.likes ? data2.likes : 0, inline: true},
          {name: 'Money', value: `${coin} ${data2.money ? data2.money : 0}`, inline: true}
          )
          .setColor('RANDOM')
